let baby = [
 ...
 localStorage.setItem("babydata",JSON.stringify(baby))

 let description = [
     {
         title:"Body Care",
         para:"Enriched with the goodness of nature’s best, explore Mamaearth Body Care range for nourished and healthy skin. Check out our newly launched toxin-free products & bring home your new favorites."
     },
     {
         title:"Hair Care",
     ...
     {
         title:"Skin Care",
         para:"Explore 100% toxin-free and safe skincare products by Mamaearth that are formulated with love and the goodness of natural ingredients",
     },
     {
     ...
     {
         title:"New Launches",
         para:"Explore the goodness of nature from Mamaearth. Take a look at our newly launched toxin-free and natural products for hair, skin, and babies",
     },
     {
         title:"Onion Range",
